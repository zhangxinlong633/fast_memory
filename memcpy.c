	...
	if( align == 0 ){
		...
		*****************************************************************************************/
		...
		if( i > 512 ){
			...
			__asm__ __volatile__(
					"\n\t"
					"vmovdqu -16*32(%[x]), %%ymm0 \n\t"
					"vmovdqu -15*32(%[x]), %%ymm1 \n\t"
					"vmovdqu -14*32(%[x]), %%ymm2 \n\t"
					"vmovdqu -13*32(%[x]), %%ymm3 \n\t"
					"vmovdqu -12*32(%[x]), %%ymm4 \n\t"
					"vmovdqu -11*32(%[x]), %%ymm5 \n\t"
					"vmovdqu -10*32(%[x]), %%ymm6 \n\t"
					"vmovdqu  -9*32(%[x]), %%ymm7 \n\t"
					"vmovdqu  -8*32(%[x]), %%ymm8 \n\t"
					"vmovdqu  -7*32(%[x]), %%ymm9 \n\t"
					"vmovdqu  -6*32(%[x]), %%ymm10\n\t"
					"vmovdqu  -5*32(%[x]), %%ymm11\n\t"
					"vmovdqu  -4*32(%[x]), %%ymm12\n\t"
					"vmovdqu  -3*32(%[x]), %%ymm13\n\t"
					"vmovdqu  -2*32(%[x]), %%ymm14\n\t"
					"vmovdqu  -1*32(%[x]), %%ymm15\n\t"
					"\n\t"
					:[x]"=r"(xx),[y]"=r"(yy)
					:"0"(xx),"1"(yy)
					);
		...
		*****************************************************************************************/
		...
		if( i > 512 ){
			...
			while( i > 512*2 ){
				...
				__asm__ __volatile__(
						"\n\t"
						"vmovdqu %%ymm0  ,  -16*32(%[y])\n\t"
						"vmovdqa  0*32(%[x]), %%ymm0 \n\t"
						"vmovdqu %%ymm1  ,  -15*32(%[y])\n\t"
						"vmovdqa  1*32(%[x]), %%ymm1 \n\t"
						"vmovdqu %%ymm2  ,  -14*32(%[y])\n\t"
						"vmovdqa  2*32(%[x]), %%ymm2 \n\t"
						"vmovdqu %%ymm3  ,  -13*32(%[y])\n\t"
						"vmovdqa  3*32(%[x]), %%ymm3 \n\t"
						"vmovdqu %%ymm4  ,  -12*32(%[y])\n\t"
						"vmovdqa  4*32(%[x]), %%ymm4 \n\t"
						"vmovdqu %%ymm5  ,  -11*32(%[y])\n\t"
						"vmovdqa  5*32(%[x]), %%ymm5 \n\t"
						"vmovdqu %%ymm6  ,  -10*32(%[y])\n\t"
						"vmovdqa  6*32(%[x]), %%ymm6 \n\t"
						"vmovdqu %%ymm7  ,   -9*32(%[y])\n\t"
						"vmovdqa  7*32(%[x]), %%ymm7 \n\t"
						"vmovdqu %%ymm8  ,   -8*32(%[y])\n\t"
						...
						"vmovdqu %%ymm9  ,   -7*32(%[y])\n\t"
						"vmovdqa  9*32(%[x]), %%ymm9 \n\t"
						"vmovdqu %%ymm10 ,   -6*32(%[y])\n\t"
						"vmovdqa 10*32(%[x]), %%ymm10\n\t"
						"vmovdqu %%ymm11 ,   -5*32(%[y])\n\t"
						"vmovdqa 11*32(%[x]), %%ymm11\n\t"
						"vmovdqu %%ymm12 ,   -4*32(%[y])\n\t"
						"vmovdqa 12*32(%[x]), %%ymm12\n\t"
						"vmovdqu %%ymm13 ,   -3*32(%[y])\n\t"
						"vmovdqa 13*32(%[x]), %%ymm13\n\t"
						"vmovdqu %%ymm14 ,   -2*32(%[y])\n\t"
						"vmovdqa 14*32(%[x]), %%ymm14\n\t"
						"vmovdqu %%ymm15 ,   -1*32(%[y])\n\t"
						"vmovdqa 15*32(%[x]), %%ymm15\n\t"
						"\n\t"
						"subq $-16*32, %[x]\n\t"
						"subq $-16*32, %[y]\n\t"
